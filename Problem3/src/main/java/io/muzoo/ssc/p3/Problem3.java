...
public class Problem3 {
    ...
    // JavaIO
    public static void download1(String fileURL, String path, String fileName) throws IOException {
    ...
    // Apache commonIO
    public static void download2(String fileURL, String path, String fileName) throws IOException {
        String desPath = path + fileName;
    ...
    public static void download3(String fileURL, String path, String fileName) throws IOException {
        String desPath = path + fileName;
